...
the change to confirm the gates it named actually worked. Prefer a script over an
assertion — an ADR that claims a gate now works should show the gate's exit code.
