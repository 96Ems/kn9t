...
/// Resolves a parsed `RawConfig` into a fully-resolved `ResolvedConfig`.
/// Made `pub(crate)` for unit tests; not part of the public API.
pub fn resolve(raw: RawConfig) -> Result<ResolvedConfig, String> {
...
pub fn build_http_quirks(r: &RawQuirks) -> HttpQuirks {
